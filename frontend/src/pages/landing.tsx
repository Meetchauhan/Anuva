        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center mr-3 bg-[#1F5A42]">
                <CheckCircle className="w-6 h-6 text-white " />
              </div>
              <h1 className="text-2xl text-red font-bold text-gray-900">AnuvaConnect</h1>
            </div>
            <Link to="/auth">
              <Button className="bg-primary hover:bg-primary/90 text-white px-6 py-2 bg-[#1F5A42]">
                Sign In
              </Button>
            </Link>
          </div>
